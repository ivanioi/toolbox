...
export default function LifeEntropy() {
    ...
    function handleReset() {
        ...
        EntropyAPIs.getEntropyInfo().then(({ data : { data : {
            ...
            setRedParticles(generateParticles('red',   Number.parseInt(updateEntropy) + Number.parseInt(defaultEntropy)));
            setGreenParticles(generateParticles('green',  Number.parseInt(updateInverseEntropy) + Number.parseInt(defaultInverseEntropy)));
        })
    }
    ...
    function handlePickDateRange(value) {
        ...
        setDefaultRedShow(false);
        setDefaultGreenShow(false);
        setUpdateRedShow(true);
        setUpdateGreenShow(true);
        ...
        EntropyAPIs.getEntropyInfo({
            startDate: format(new Date(pickedDateRange.startDate), 'yyyy-MM-dd'),
            endDate: format(new Date(pickedDateRange.endDate), 'yyyy-MM-dd'),
        }).then(({ data : { data : {
                defaultEntropy, defaultInverseEntropy, updateEntropy, updateInverseEntropy
        }}}) => {
            ...
            setRedParticles(generateParticles('red',   Number.parseInt(updateEntropy)));
            setGreenParticles(generateParticles('green',  Number.parseInt(updateInverseEntropy)));
        })
